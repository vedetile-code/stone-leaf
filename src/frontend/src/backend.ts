...
import type { Cell as _Cell, Error as _Error, Result as _Result, Result__1 as _Result__1, SubmitResult as _SubmitResult, UserRole as _UserRole, ValidationError as _ValidationError, Value as _Value, ViewingRequest as _ViewingRequest } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async listViewingRequests(): Promise<Array<ViewingRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.listViewingRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitViewingRequest(arg0: ViewingRequestInput): Promise<SubmitResult> {
        if (this.processError) {
            try {
                const result = await this.actor.submitViewingRequest(arg0);
                return from_candid_SubmitResult_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_SubmitResult_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmitResult): SubmitResult {
...
function from_candid_ValidationError_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ValidationError): ValidationError {
    return "messageRequired" in value ? ValidationError.messageRequired : "emailInvalid" in value ? ValidationError.emailInvalid : "phoneRequired" in value ? ValidationError.phoneRequired : "preferredDateRequired" in value ? ValidationError.preferredDateRequired : "nameRequired" in value ? ValidationError.nameRequired : "emailRequired" in value ? ValidationError.emailRequired : value;
}
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "ok" in value ? {
        ...
        __kind__: "err",
        err: from_candid_vec_n17(_uploadFile, _downloadFile, value.err)
    } : value;
}
...
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ValidationError>): Array<ValidationError> {
    return value.map((x)=>from_candid_ValidationError_n18(_uploadFile, _downloadFile, x));
}
